...
- Customer-owned Telegram rich-message notifications (**Pro**) with tokens managed from the Strapi admin; outbound-only, with no deployment or webhook required ([setup guide](docs/telegram.md))
