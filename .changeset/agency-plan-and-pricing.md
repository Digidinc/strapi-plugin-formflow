...
Paid plans are now Pro US$149/yr (1 project), Business US$449/yr (3 projects), and Agency US$999/yr (unlimited projects) — all annual, with no lifetime SKU. The free MIT tier is unchanged; the open-core line has not moved. Existing subscriptions renew at the price they were bought at. See ADR-0003 for the reasoning, which also amends ADR-0002's "exactly two plans" consequence.
